<template>
    <n-modal
            ...
            class="custom-card !tw-w-4/6 sm:!tw-w-1/2 lg:!tw-w-1/3 !tw-rounded-2xl tw-text-center"
            preset="card"
    ...
    >
        ...
        <n-button class="!tw-block !tw-mx-auto" type="primary" @click="resetGet"
                  :disabled="resetData.resetStatus != 0">
        ...
        <n-input v-model:value="resetData.password" type="text"
